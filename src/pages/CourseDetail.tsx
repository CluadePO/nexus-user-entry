...
const mockCourseDetails = {
  ...
  '4': {
    ...
    participants: 3200,
    provider: {
      name: 'Digital Academy Chile',
      rut: '79.456.789-0',
      website: 'www.digitalacademy.cl',
    ...
    effectiveValuePerParticipant: 150000,
    maxImputableValue: 0,
    objective: 'Desarrollar competencias en estrategias de marketing digital y gestión profesional de redes sociales para potenciar la presencia online de la organización.',
    targetAudience: 'Profesionales de marketing, community managers, emprendedores y todo aquel que desee profesionalizar su estrategia digital.',
    requirements: 'Manejo básico de internet y redes sociales. No requiere conocimientos previos avanzados.',
    description: 'Curso práctico de marketing digital que abarca desde la estrategia hasta la ejecución en redes sociales, SEO, SEM y análisis de métricas.',
    learnings: [
      'Diseñar estrategias de marketing digital',
      'Gestionar campañas en redes sociales',
      'Crear contenido atractivo y efectivo',
      'Medir y analizar resultados',
      'Optimizar campañas pagadas',
    ],
    relatedTopics: ['SEO', 'Google Ads', 'Content Marketing', 'Analytics'],
  },
  '5': {
    id: '5',
    name: 'Inglés de Negocios para Profesionales',
    type: 'No Sence',
    modality: 'E-learning',
    ...
    provider: {
      ...
      rut: '76.567.890-1',
      website: 'www.globallanguage.cl',
      phone: '+56 2 5678 9012',
    },
    senceCode: '',
    hours: 30,
    area: 'Idiomas',
    specialty: 'Inglés Comercial',
    location: 'Online - Todo Chile',
    price: 220000,
    effectiveValuePerParticipant: 220000,
    maxImputableValue: 0,
    objective: 'Desarrollar competencias comunicativas en inglés aplicadas al entorno empresarial y profesional.',
    targetAudience: 'Profesionales, ejecutivos y emprendedores que requieran utilizar inglés en contextos de negocios.',
    requirements: 'Nivel intermedio de inglés (A2-B1). Acceso a computador con internet estable.',
    description: 'Programa 100% online de inglés enfocado en situaciones reales de negocios: reuniones, presentaciones, correos y negociaciones internacionales.',
    learnings: [
      'Comunicarse efectivamente en reuniones de negocios',
      'Redactar correos y reportes profesionales',
      'Realizar presentaciones en inglés',
      'Negociar y cerrar acuerdos comerciales',
      'Manejar vocabulario técnico y financiero',
    ],
    relatedTopics: ['Comunicación Efectiva', 'Negociación Internacional', 'Cultura Corporativa'],
  },
  '6': {
    id: '6',
    name: 'Atención al Cliente de Excelencia',
    type: 'No Sence',
    modality: 'Presencial',
    ...
    participants: 1420,
    provider: {
      name: 'Centro de Servicios Profesionales',
      rut: '77.678.901-2',
      website: 'www.centroservicios.cl',
      phone: '+56 2 6789 0123',
    },
    senceCode: '',
    hours: 16,
    area: 'Servicio al Cliente',
    specialty: 'Experiencia del Cliente',
    location: 'Santiago, Región Metropolitana',
    price: 180000,
    effectiveValuePerParticipant: 180000,
    maxImputableValue: 0,
    objective: 'Entregar herramientas prácticas para ofrecer una atención al cliente memorable y diferenciadora.',
    targetAudience: 'Personal de atención al cliente, vendedores, supervisores de servicio y equipos de post-venta.',
    requirements: 'Experiencia previa en atención de público deseable. Disposición para dinámicas presenciales.',
    description: 'Taller presencial intensivo con role-playing y casos reales para potenciar la experiencia del cliente y fidelización.',
    learnings: [
      'Aplicar protocolos de atención de excelencia',
      'Manejar clientes difíciles y reclamos',
      'Comunicación verbal y no verbal efectiva',
      'Construir relaciones de fidelización',
      'Trabajar en equipo en momentos críticos',
    ],
    relatedTopics: ['Ventas Consultivas', 'Comunicación Efectiva', 'Gestión de Reclamos'],
  },
  '7': {
    id: '7',
    name: 'Gestión de Proyectos con Metodología Agile',
    type: 'No Sence',
    modality: 'Presencial',
    ...
    provider: {
      name: 'Innovation Hub',
      rut: '78.789.012-3',
      website: 'www.innovationhub.cl',
      phone: '+56 2 7890 1234',
    },
    senceCode: '',
    hours: 24,
    area: 'Gestión de Proyectos',
    specialty: 'Agile y Scrum',
    location: 'Valparaíso, Región de Valparaíso',
    price: 320000,
    effectiveValuePerParticipant: 320000,
    maxImputableValue: 0,
    objective: 'Formar líderes de proyectos capaces de aplicar metodologías Agile y Scrum en contextos reales de trabajo.',
    targetAudience: 'Gerentes de proyectos, líderes técnicos, coaches Agile y equipos multidisciplinarios.',
    requirements: 'Experiencia mínima en gestión de equipos. Conocimientos básicos de planificación.',
    description: 'Programa presencial intensivo con simulaciones y dinámicas grupales para dominar Scrum, Kanban y herramientas de gestión visual.',
    learnings: [
      'Aplicar el marco Scrum en proyectos reales',
      'Facilitar ceremonias Agile efectivas',
      'Gestionar backlogs y priorización',
      'Medir velocidad y rendimiento de equipos',
      'Liderar equipos autoorganizados',
      'Adaptar Agile a distintos contextos organizacionales',
    ],
    relatedTopics: ['Scrum Master', 'Kanban', 'Design Thinking', 'Liderazgo de Equipos'],
  },
  '9': {
    id: '9',
    ...
    participants: 1350,
    provider: {
      name: 'Instituto de Habilidades Profesionales',
      rut: '79.123.456-7',
      website: 'www.ihp.cl',
      phone: '+56 2 2345 6789',
    },
    ...
    hours: 18,
    area: 'Habilidades Blandas',
    specialty: 'Comunicación Organizacional',
    location: 'Santiago, Región Metropolitana',
    price: 195000,
    effectiveValuePerParticipant: 195000,
    maxImputableValue: 0,
    objective: 'Desarrollar competencias de comunicación asertiva para mejorar las relaciones interpersonales en el entorno laboral, gestionar conflictos de manera constructiva y expresar ideas con claridad y respeto.',
    targetAudience: 'Profesionales de todas las áreas que busquen mejorar sus habilidades de comunicación, trabajadores con funciones de coordinación de equipos y personal de atención al cliente.',
    requirements: 'No requiere conocimientos previos. Disposición para participar en dinámicas grupales y role-playing presenciales.',
    description: 'Taller presencial intensivo diseñado para potenciar la comunicación asertiva en el trabajo. A través de ejercicios prácticos, role-playing y estudios de caso, los participantes aprenderán a expresar sus ideas con claridad, escuchar activamente, manejar conflictos y construir relaciones laborales más efectivas.',
    learnings: [
      'Identificar y aplicar los principios de la comunicación asertiva',
      'Diferenciar entre comunicación pasiva, agresiva y asertiva',
      'Practicar técnicas de escucha activa y empatía',
      'Manejar conversaciones difíciles y conflictos laborales',
      'Dar y recibir retroalimentación constructiva',
      'Comunicar límites y necesidades con respeto',
    ],
    relatedTopics: ['Inteligencia Emocional', 'Negociación', 'Trabajo en Equipo', 'Liderazgo'],
  },
};
...
const FranchiseCalculator: React.FC<FranchiseCalculatorProps> = ({
  ...
  return (
    <>
      ...
      {/* Expanded Sidebar */}
      <div
        className={`fixed right-0 top-0 bottom-0 h-screen min-h-screen z-[60] transition-transform duration-300 ${
